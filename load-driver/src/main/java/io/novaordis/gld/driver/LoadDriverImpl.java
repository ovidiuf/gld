...
import io.novaordis.gld.embedded.EmbeddedKeyStore;
import io.novaordis.gld.embedded.EmbeddedService;
...
public class LoadDriverImpl implements LoadDriver {
    ...
    public void init() throws Exception {
        ...
        LoadStrategy loadStrategy = service.getLoadStrategy();

        multiThreadedRunner = new MultiThreadedRunnerImpl(
                service, loadStrategy, threadCount, sampler, background, singleThreadedRunnerSleepMs);
    }
