...
import io.novaordis.gld.api.sampler.metrics.MockMeasureUnit;
...
public class CSVFormatTest extends FormatTest {
    ...
    public void orderOperationTypes_OneOperations() throws Exception {
        ...
        assertEquals(MockSamplerOperation.class, ordered.get(0));
    }
    ...
    public void orderOperationTypes_TwoOperations() throws Exception {
        ...
        assertEquals(AnotherTypeOfMockSamplerOperation.class, ordered.get(0));
        assertEquals(MockSamplerOperation.class, ordered.get(1));
    }
    ...
    public void getSuccessRateHeader() throws Exception {
        CSVFormat format = getFormatToTest();
        String result = format.getSuccessRateHeader(MockSamplerOperation.class);
        assertEquals("MockSamplerOperation Success Rate (ops/sec)", result);
    }
    ...
    public void getSuccessAverageDurationHeader() throws Exception {
        ...
        String result = format.getSuccessAverageDurationHeader(MockSamplerOperation.class);
        assertEquals("MockSamplerOperation Average Duration (ns)", result);
    }
    ...
    public void getFailureRateHeader() throws Exception {
        ...
        CSVFormat format = getFormatToTest();
        String result = format.getFailureRateHeader(MockSamplerOperation.class);
        assertEquals("MockSamplerOperation Failure Rate (ops/sec)", result);
    }
