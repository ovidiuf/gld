...
public class MockRemoteCache implements RemoteCache {
    ...
    @Override
    public CompletableFuture<Boolean> removeWithVersionAsync(Object key, long version) {
    ...
    @Override
    public CompletableFuture<Boolean> replaceWithVersionAsync(Object key, Object newValue, long version) {
        throw new NotYetImplementedException("replaceWithVersionAsync() NOT YET IMPLEMENTED");
    }

    @Override
    public CompletableFuture<Boolean> replaceWithVersionAsync(Object key, Object newValue, long version, int lifespanSeconds) {
        throw new NotYetImplementedException("replaceWithVersionAsync() NOT YET IMPLEMENTED");
    }

    @Override
    public CompletableFuture<Boolean> replaceWithVersionAsync(Object key, Object newValue, long version, int lifespanSeconds, int maxIdleSeconds) {
        throw new NotYetImplementedException("replaceWithVersionAsync() NOT YET IMPLEMENTED");
    }
    ...
    @Override
    public Object execute(String scriptName, Map params) {
        throw new NotYetImplementedException("execute() NOT YET IMPLEMENTED");
    }
