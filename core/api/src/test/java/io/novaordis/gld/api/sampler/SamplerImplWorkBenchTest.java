...
public class SamplerImplWorkBenchTest {
    ...
    public void syntheticLife_NoSteppingOutsideTheBoundariesOfASamplingInterval() throws Exception
    {
        ...
        assertTrue(operationTypesSnapshot.contains(MockSamplerOperation.class));
        CounterValues counterValuesSnapshot = current.getCounterValues(MockSamplerOperation.class);
        ...
        assertTrue(collectedOperationTypes.contains(MockSamplerOperation.class));
        CounterValues collectedCounterValues = si.getCounterValues(MockSamplerOperation.class);
        ...
        s.record(System.currentTimeMillis(), 28L, 35L, new MockSamplerOperation()); // 7
        s.record(System.currentTimeMillis(), 36L, 44L, new MockSamplerOperation(), new ConnectException()); // 8
        ...
        CounterValues counterValues = si2.getCounterValues(MockSamplerOperation.class);
    ...
    public void syntheticLife_MultipleSamplesAccumulate() throws Exception
    {
        ...
        for(int i = 0; i < n; i ++)
        {
            ...
            assertTrue(si.getOperationTypes().contains(MockSamplerOperation.class));

            CounterValues cv = si.getCounterValues(MockSamplerOperation.class);
