...
import com.novaordis.cld.command.Connect;
import com.novaordis.cld.command.Content;
import com.novaordis.cld.command.Delete;
import com.novaordis.cld.command.GenerateKeys;
import com.novaordis.cld.command.Help;
import com.novaordis.cld.command.Load;
import com.novaordis.cld.command.Test;
import com.novaordis.cld.command.Version;
import com.novaordis.cld.service.EmbeddedCacheService;
import com.novaordis.cld.service.infinispan.InfinispanService;
...
public class ConfigurationImpl implements Configuration
{
    ...
    private void parseCommandLine(String[] args) throws Exception
    {
        ...
        if (hasPassword)
        {
            // we need to read the password from the current directory's .cld.password file.
            ...
            String passwordFileName = passwordFileDirectory + "/.cld.password";
