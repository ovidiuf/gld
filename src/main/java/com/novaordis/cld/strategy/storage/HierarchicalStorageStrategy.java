...
public class HierarchicalStorageStrategy extends StorageStrategyBase
{
    ...
    /**
     * @see com.novaordis.cld.StorageStrategy#configure(Configuration, java.util.List, int)
     */
    @Override
    ...
    /**
     * @see com.novaordis.cld.StorageStrategy#start()
     */
    @Override
    ...
    /**
     * @see com.novaordis.cld.StorageStrategy#store(String, String)
     */
    @Override
    ...
    /**
     * @see com.novaordis.cld.StorageStrategy#retrieve(String)
     */
    @Override
