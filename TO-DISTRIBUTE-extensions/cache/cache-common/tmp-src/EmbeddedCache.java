...
public class EmbeddedCache implements RemoteCache {
    ...
    @Override
    public CloseableIterator<Map.Entry<Object, MetadataValue<Object>>> retrieveEntriesWithMetadata(Set set, int i) {
        throw new RuntimeException("retrieveEntriesWithMetadata() NOT YET IMPLEMENTED");
    }

    @Override
    public CloseableIterator<Map.Entry<Object, Object>> retrieveEntriesByQuery(Query query, Set set, int i) {
        throw new RuntimeException("retrieveEntriesByQuery() NOT YET IMPLEMENTED");
    }

    @Override
    public CloseableIterator<Map.Entry<Object, Object>> retrieveEntries(String s, Object[] objects, Set set, int i) {
        throw new RuntimeException("retrieveEntries() NOT YET IMPLEMENTED");
    }

    @Override
    public CloseableIterator<Map.Entry<Object, Object>> retrieveEntries(String s, Set set, int i) {
        throw new RuntimeException("retrieveEntries() NOT YET IMPLEMENTED");
    }
